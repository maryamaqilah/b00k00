...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=4;';
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=5;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=10;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=11;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
