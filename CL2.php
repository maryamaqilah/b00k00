...
<hr>
<div class="try" >
<h1 style="font-size: 30px; color:#456B8D">COMPUTER LANGUAGES BOOKS</h1>
</div>
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=1;';
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=2;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=7;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=9;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
