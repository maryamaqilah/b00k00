...
<div class='card'>
<?php
  $que = 'SELECT price, picture FROM books WHERE id=1;';
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=2;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=7;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT price,picture FROM books WHERE id=9;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
   $n = $t['price'];
  $p = $t['picture'];
