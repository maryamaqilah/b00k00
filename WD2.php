...
<hr>
<div class="try" >
<h1 style="font-size: 30px; color:#456B8D">COMPUTER NETWORK BOOKS</h1>
</div>
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=12;';
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=13;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=14;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
...
<div class='card'>
<?php
  $que = 'SELECT title, price, picture FROM books WHERE id=15;';
  $tajuk = mysqli_query($conn, $que) or die('Query eror!');
  while ($t = mysqli_fetch_assoc($tajuk)) {
    $n = $t['price'];
    $p = $t['picture'];
